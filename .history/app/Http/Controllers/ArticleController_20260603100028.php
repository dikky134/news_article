...
class ArticleController extends Controller
{
    ...
    public function update(Request $request, Article $article)
    {
        $validated = $request->validate([
            ...
            'thumbnail' => 'nullable|image|mimes:jpeg,png,jpg,webp|max:10240', // Maksal 10MB
            'allow_comments' => 'nullabel',
            'feature_on_homepage' => 'nullabel',
        ]);
        
        $validatedData['allow_comments'] = $request->has('allow_comments') ? filter_var($request->allow_comments, FILTER_VALIDATE_BOOLEAN) : false;
        $validatedData['feature_on_homepage'] = $request->has('feature_on_homepage') ? filter_var($request->feature_on_homepage, FILTER_VALIDATE_BOOLEAN) : false;
