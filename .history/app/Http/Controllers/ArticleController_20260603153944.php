...
class ArticleController extends Controller
{
    ...
    public function update(Request $request, Article $article)
    {
        ...
        $isDraft = filter_var($request->is_draft, FILTER_VALIDATE_BOOLEAN);
        $validated['status'] = $isDraft ? 'draft' : 'published';
        ...
        // 5. Redirect sesuai kondisi status akhir
        if ($validated['status'] === 'published') {
            return redirect()->route('articles.index')->with('message', 'Draf berhasil diterbitkan menjadi artikel!');
        }
