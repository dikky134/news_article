...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::post('/articles', [ArticleController::class, 'store']);     // URL: /admin/articles
    Route::post('/drafts', [ArticleController::class, 'storeDraft']);   // URL: /admin/drafts

    // Route edit dan update
