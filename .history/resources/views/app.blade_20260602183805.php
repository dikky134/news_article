...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title inertia>{{ config('app.name', 'The Archive') }}</title>
        <link rel="icon" type="image/png" href="{{ asset('newspaper.png') }}">
        <!-- Fonts -->
    ...
    <body class="font-sans antialiased w-full min-h-screen overflow-x-hidden m-0 p-0">
        @inertia
    </body>
</html>
