...
export default function Create({ categories = [], article=null }) {
    ...
    useEffect(() => {
        // Jika ada flash message berkunci 'success', munculkan pop-up
        if (flash?.success) {
            Swal.fire({
                title: 'Berhasil!',
                text: flash.success,
                icon: 'success',
                timer: 3000, // Pop-up otomatis menutup dalam 3 detik
                timerProgressBar: true,
                showConfirmButton: false,
                background: '#ffffff', // Sesuaikan jika menggunakan dark mode
                customClass: {
                    popup: 'rounded-2xl shadow-xl border border-slate-100',
                    title: 'text-emerald-600 font-bold font-sans text-xl',
                }
            });
        }
    }, [flash]);
