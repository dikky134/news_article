...
export default function Article({ activePage, articles = [], filters = [], categories = [] }) {
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                                <Link
                                    href="/articles"
                                    className={`px-4 py-2 text-sm font-label-caps ${
                                        activePage === 'articles' ? 'bg-primary text-white' : 'text-on-surface'
                                    }`}
                                >
                                    ALL TOPICS
                                </Link>
                                ...
                                {categories && categories.map((cat) => (
                                    <Link
                                        key={cat.id}
                                        // Mengarahkan ke rute artikel dengan query filter sesuai slug di database
                                        href={`/articles?category=${cat.slug}`}
                                        className={`px-4 py-2 text-sm font-label-caps uppercase ${
                                            activePage === cat.slug ? 'bg-primary text-white' : 'text-on-surface'
                                        }`}
                                    >
                                        {cat.name}
                                    </Link>
