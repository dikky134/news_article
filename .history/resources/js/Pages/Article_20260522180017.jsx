                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                                <button
                                    ...
                                    className={`px-5 py-2 font-label-caps text-[11px] border transition-all duration-300 ${!filters.category ? 'bg-primary dark:bg-on-secondary text-white dark:text-white border-primary' : 'border-outline-variant hover:bg-secondary hover:border-secondary'}`}
                                >
                                    ALL TOPICS
                                </button>
                                {categories.map((cat) => (
