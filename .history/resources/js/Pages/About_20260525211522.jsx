            ...
            <main className="max-w-content-max-width mx-auto px-margin-edge bg-surface dark:bg-[#121212] dark:text-on-secondary border-outline-variant dark:border-zinc-800">
                ...
                <section className="mb-section-gap grid grid-cols-12 gap-gutter">
                    ...
                    <div className="col-span-12 md:col-span-7 md:col-start-5 space-y-8">
                        ...
                        <p className="font-body-md text-body-md text-on-surface-variant dark:text-on-primary-container leading-relaxed text-justify">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="p-8 border border-outline-variant flex flex-col items-start hover:shadow-sm transition-shadow">
                                ...
                                <p className="text-on-surface-variant dark:text-on-primary-container font-body-md">{principle.desc}</p>
                            </div>
                        ))}
                    </div>
                </section>
                ...
                <section className="mb-section-gap">
                    <div className="flex justify-between items-end mb-12">
                        <div>
                            <span className="font-label-caps text-label-caps text-secondary dark:text-amber-500 block mb-2">THE EDITORIAL BOARD</span>
                            <h2 className="font-headline-lg text-headline-lg text-primary dark:text-on-secondary">Leading the Conversation</h2>
                        </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-gutter">
                        {[
                            ...
                            <div key={i} className="group cursor-pointer">
                                ...
                                <h4 className="font-label-caps text-label-caps text-primary dark:text-on-secondary">{member.name}</h4>
                                <p className="text-on-surface-variant dark:text-on-primary-container text-[14px]">{member.role}</p>
                            </div>
                        ))}
                    </div>
                </section>
