            ...
            <main className="max-w-content-max-width mx-auto px-margin-edge bg-surface dark:bg-[#121212] dark:text-white border-outline-variant dark:border-zinc-800">
                ...
                <section className="py-section-gap grid grid-cols-12 gap-gutter items-center border-b border-outline-variant">
                    ...
                    <div className="col-span-12 lg:col-span-5 relative">
                        ...
                        {/* Floating Choice Box */}
                        <div className="absolute bottom-2 left-2 xl:-bottom-6 xl:-left-6 bg-surface dark:bg-primary p-3 xl:p-5 shadow-md border border-outline-variant max-w-[180px] xl:max-w-[220px]">
                            <span className="font-label-caps text-[8px] xl:text-[10px] text-secondary dark:text-amber-500 font-bold uppercase tracking-[0.15em] block">
                                EDITORIAL CHOICE
                            </span>
                            <p className="text-primary dark:text-on-secondary font-display-sm text-[12px] xl:text-[18px] mt-0.5 italic leading-tight font-semibold">
