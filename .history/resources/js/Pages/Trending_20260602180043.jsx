    ...
    return (
        <MainLayout activePage="trending">
            ...
            <main className="max-w-content-max-width mx-auto px-margin-edge py-section-gap bg-surface dark:bg-[#121212] dark:text-white border-outline-variant dark:border-zinc-800">
                ...
                {/* MODIFIKASI: Menggunakan flex-col pada mobile agar order-1 & order-2 berfungsi, dan md:grid untuk desktop */}
                <div className="flex flex-col md:grid md:grid-cols-12 gap-gutter">
                    
                    {/* Main Feature Card (Top Trending #01) */}
                    {mainFeature && (
                    ...
                    <section className="order-2 md:order-none md:col-span-4 border-t pt-8 md:pt-0 md:border-t-0 md:border-r border-outline-variant pr-0 md:pr-gutter">
                ...
                <div className="mt-section-gap grid grid-cols-1 md:grid-cols-3 gap-gutter">
                    {bentoRow.map((item, index) => (
                        ...
                        >
                            <span className="font-display-xl text-primary dark:text-on-secondary opacity-50 text-headline-md mb-2 block">
