...
export default function ArticleDetail({ article, auth, relatedArticles = [] }) {
    ...
    return (
        <MainLayout activePage={article.category?.slug}>
            ...
            {showToast && (
                <div className="fixed top-24 right-5 z-50 flex items-center w-full max-w-xs p-4 space-x-4 text-gray-500 bg-white rounded-xl shadow-2xl dark:text-gray-400 dark:bg-zinc-950 border border-emerald-100 dark:border-emerald-950/30 animate-fade-in-left transition-all duration-300">
