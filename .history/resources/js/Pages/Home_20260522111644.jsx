                ...
                <section className="py-section-gap grid grid-cols-12 gap-gutter items-center border-b border-outline-variant">
                    <div className="col-span-12 lg:col-span-7">
                        ...
                        <div className="flex gap-4">
                            <button className="bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900 px-8 py-4 font-label-caps text-label-caps hover:bg-secondary dark:hover:bg-amber-500 transition-colors duration-300 uppercase tracking-widest font-bold cursor-pointer">
