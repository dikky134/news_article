...
export default function Create({ categories = [] }) {
    ...
    return (
        <MainLayout>
            ...
            {/* PERBAIKAN: Mengganti px-margin-edge menjadi responsif px-4 md:px-margin-edge */}
            <main className="max-w-content-max-width mx-auto px-4 md:px-margin-edge py-12 w-full overflow-x-hidden">
                ...
                <div className="mb-10 md:mb-12 flex flex-col md:flex-row md:items-end justify-between border-b border-outline-variant pb-6 md:pb-8">
                    <div className="max-w-2xl">
                        ...
                        {/* PERBAIKAN: Ukuran judul utama halaman dibuat responsif */}
                    ...
                    {/* PERBAIKAN: Tombol aksi dibuat fleksibel (full-width di mobile) */}
                    <div className="flex flex-col-reverse sm:flex-row gap-3 mt-6 md:mt-0 w-full md:w-auto">
                        <button 
                            type="button"
                            className="w-full sm:w-auto px-6 py-3 border border-primary dark:border-white font-label-caps text-[11px] md:text-label-caps hover:bg-surface-container dark:hover:bg-zinc-800 transition-all dark:text-white uppercase tracking-widest"
                        >
                            Save Draf
                        </button>
                        <button 
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-gutter w-full">
                    ...
                    <div className="lg:col-span-8 space-y-8 md:space-y-10 w-full">
                        ...
                        <section className="space-y-6">
                            <div>
                                ...
                                {/* PERBAIKAN: Menyesuaikan text-headline-lg menjadi responsif text-xl md:text-headline-lg dan menambahkan text-base di mobile */}
                                <input 
                                    type="text"
                                    value={data.title}
                            ...
                            <div>
                                ...
                                {/* PERBAIKAN: Mengatur teks area agar menggunakan text-base pada mobile agar tidak auto-zoom */}
                                <textarea 
                                    rows="2"
                        ...
                        <section className="w-full">
                            ...
                            <div className="border border-outline-variant bg-surface-container-lowest dark:bg-zinc-900 w-full">
                                ...
                                {/* PERBAIKAN: Menyesuaikan padding p-4 untuk mobile dan p-8 untuk desktop, serta text-base */}
                                <textarea
                                    rows="12"
                                    value={data.content}
                    ...
                    <aside className="lg:col-span-4 space-y-6 md:space-y-8 w-full">
                        <div className="bg-surface-container-low dark:bg-zinc-900 p-6 md:p-8 border border-outline-variant space-y-6 md:space-y-8">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    {/* PERBAIKAN: Teks dropdown diatur text-base / text-sm responsif */}
                                    <select 
                        ...
                        <div className="border border-outline-variant p-4 md:p-6 space-y-4 w-full">
                            ...
                            <div className="group bg-white dark:bg-zinc-900 p-4 shadow-sm border border-outline-variant/30 w-full">
                                ...
                                {/* PERBAIKAN: Mengecilkan teks headline pada pratinjau kartu di mobile */}
