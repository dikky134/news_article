                            ...
                            <article className="col-span-12 lg:col-span-8 group cursor-pointer">
                                <Link href={`/articles/${mainHighlight.slug}`}>
                                    ...
                                    <div className="flex gap-4 mb-3">
                                        <span className="font-label-caps text-label-caps bg-secondary-container px-2 py-1 uppercase">
                                    ...
                                    <p className="font-body-md text-body-md text-primary-fixed-dim line-clamp-3">
