                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                {/* === SINKRONISASI DATABASE: Looping Kategori Dinamis === */}
                                {categories && categories.map((cat) => (
                                    <button
                                        key={cat.id}
                                        // Mengirim slug ke fungsi filter saat diklik (contoh: 'politik', 'olahraga')
                                    ...
                                    >
                                        {cat.name} {/* Menampilkan Nama Kategori dari phpMyAdmin */}
                                    </button>
                                ))}
                            </div>
