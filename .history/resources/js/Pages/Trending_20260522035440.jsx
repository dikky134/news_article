...
export default function Trending({ trendingArticles = [], stats }) {
    ...
    return (
        <MainLayout activePage="trending">
            ...
            {/* Reading Progress Bar - SEKARANG HANYA ADA SATU DAN BERFUNGSI SEMPURNA */}
            <div 
                className="fixed top-0 left-0 h-[2px] bg-secondary z-[100] transition-all duration-100 ease-out"
                style={{ width: `${scrollProgress}%` }}
            ></div>

            {/* BAR ELEMEN YANG STATIS W-[35%] SEBELUMNYA SUDAH DIHAPUS DARI SINI */}

            <main className="max-w-content-max-width mx-auto px-margin-edge py-section-gap">
                <header className="mb-16 border-b border-outline-variant pb-8">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                        <div>
                            ...
                            <h2 className="font-display-xl text-headline-lg lg:text-display-xl mb-2 text-primary">
                                Trending Now
                            </h2>
