            ...
            <main className="max-w-content-max-width mx-auto px-margin-edge bg-surface dark:bg-[#121212] dark:text-white border-outline-variant dark:border-zinc-800">
                ...
                <section className="py-section-gap grid grid-cols-12 gap-gutter items-center border-b border-outline-variant">
                    ...
                    <div className="col-span-12 lg:col-span-5 relative">
                        ...
                        <div class="absolute -bottom-6 -left-6 bg-surface p-6 shadow-sm border border-outline-variant hidden xl:block max-w-[240px]">
                            <span class="font-label-caps text-[10px] text-secondary">EDITORIAL CHOICE</span>
                            <p class="font-headline-md text-body-md mt-2">"The architecture of modern truth requires a new lens."</p>
                        </div>
                        {/* Floating Choice Box */}
