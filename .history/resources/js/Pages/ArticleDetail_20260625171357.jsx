                ...
                <div className="flex-grow min-w-0">
                    <div className="flex justify-between items-center mb-1 md:mb-2 gap-2">
                        <div className="flex items-center gap-2">
                            ...
                            {isCommentFromAdmin && (
                                <span className="text-[9px] bg-secondary/10 dark:bg-amber-500/10 text-secondary dark:text-amber-500 font-extrabold px-1.5 py-0.5 tracking-widest uppercase rounded-sm">
                                    Admin
                                </span>
                            )}
                        </div>
