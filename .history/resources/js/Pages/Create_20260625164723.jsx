                ...
                <div className="mb-10 md:mb-12 flex flex-col md:flex-row md:items-end justify-between border-b border-outline-variant pb-6 md:pb-8">
                    ...
                    <div className="flex flex-col-reverse sm:flex-row gap-3 mt-6 md:mt-0 w-full md:w-auto">
                        ...
                        <button 
                            ...
                            disabled={processing}
                            className="w-full sm:w-auto px-6 py-3 bg-primary dark:bg-on-secondary dark:hover:bg-amber-600 text-white dark:text-primary font-label-caps text-[11px] md:text-label-caps hover:shadow-lg transition-all disabled:opacity-50 uppercase tracking-widest cursor-pointer"
                        >
