                            ...
                            {leftPillar.map((item, index) => (
                                ...
                                >
                                    <div className="flex items-start gap-4">
                                        <span className="text-3xl font-extrabold text-primary dark:text-on-secondary opacity-20 dark:opacity-80 md:font-extrabold md:text-headline-md lg:font-display-xl lg:text-headline-lg leading-none">
