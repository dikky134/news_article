            ...
            <main className="max-w-content-max-width mx-auto px-margin-edge bg-surface dark:bg-[#121212] dark:text-on-secondary border-outline-variant dark:border-zinc-800">
                ...
                <section className="py-section-gap grid grid-cols-12 gap-gutter">
                    <div className="col-span-12 md:col-span-8">
                        <span className="font-label-caps text-label-caps text-secondary dark:text-on-secondary mb-4 block">OUR MANIFESTO</span>
                        <h1 className="font-display-xl text-display-xl mb-8 text-primary">
                ...
                <section className="mb-section-gap grid grid-cols-12 gap-gutter">
                    <aside className="col-span-12 md:col-span-3">
                        <div className="sticky top-32">
                            <h2 className="font-label-caps text-label-caps text-primary mb-6">THE GENESIS</h2>
                            <p className="text-on-surface-variant font-body-md italic mb-4">"We don't aggregate; we curate. We don't skim; we delve."</p>
