                            ...
                            <Link href={`/articles/${mainFeature.slug}`} className="cursor-pointer block">
                                ...
                                <div className="flex flex-col gap-4">
                                    <div className="flex items-center gap-4">
                                        <span className="text-on-surface-variant font-label-caps uppercase font-bold text-primary dark:text-on-secondary">BY {mainFeature.user?.name || 'EDITORIAL'}</span>
