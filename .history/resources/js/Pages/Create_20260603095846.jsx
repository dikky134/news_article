                    ...
                    <aside className="lg:col-span-4 space-y-6 md:space-y-8 w-full">
                        <div className="bg-surface-container-low dark:bg-zinc-900 p-6 md:p-8 border border-outline-variant space-y-6 md:space-y-8">
                            ...
                            <div className="pt-5 border-t border-outline-variant space-y-4">
                                <label className="font-label-caps text-[11px] md:text-label-caps text-on-surface-variant block uppercase tracking-widest">
                                    Visibility Settings
                                </label>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className={`w-10 h-5 rounded-full flex items-center px-1 cursor-pointer transition-colors duration-300 focus:outline-none ${
                                            data.allow_comments ? 'bg-secondary dark:bg-amber-600' : 'bg-slate-300 dark:bg-zinc-700'
                                        }`}
                                    >
                                        <div 
                                            className={`w-3 h-3 bg-white rounded-full shadow-md transform transition-transform duration-300 ${
                                                data.allow_comments ? 'translate-x-5' : 'translate-x-0'
                                            }`}
                                        ></div>
                                    </button>
                                </div>

                                {/* TOGGLE 2: Feature on Homepage */}
                                <div className="flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className={`w-10 h-5 rounded-full flex items-center px-1 cursor-pointer transition-colors duration-300 focus:outline-none ${
                                            data.feature_on_homepage ? 'bg-secondary dark:bg-amber-600' : 'bg-slate-300 dark:bg-zinc-700'
                                        }`}
                                    >
                                        <div 
                                            className={`w-3 h-3 bg-white rounded-full shadow-md transform transition-transform duration-300 ${
                                                data.feature_on_homepage ? 'translate-x-5' : 'translate-x-0'
                                            }`}
                                        ></div>
                                    </button>
                                </div>
