                        ...
                        <div className="flex flex-col gap-4 pt-4 border-t border-outline-variant/30">
                            ...
                            <div className="flex flex-wrap items-center gap-6">
                                <div className="flex items-center gap-2">
                                    <label className="font-label-caps text-[11px] text-60 uppercase">Date:</label>
                                    <input 
                                        type="date" 
                                        ...
                                        className="border border-outline-variant px-3 py-1.5 text-xs font-body-md focus:outline-secondary bg-transparent"
                                    />
                                </div>
