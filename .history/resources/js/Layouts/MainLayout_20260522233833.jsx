...
export default function MainLayout({ children, activePage, categories = [] }) {
    ...
    return (
        <div className="min-h-screen bg-background text-on-background font-body-md">
            ...
            <div className="w-full h-0.5 bg-surface-container dark:bg-zinc-800 relative overflow-hidden bg-surface dark:bg-[#121212] text-primary dark:text-white border-outline-variant dark:border-zinc-800">
                <div 
