                            ...
                            {user ? (
                                <div className="space-y-4">
                                    ...
                                    {getRoleName(user.role) === 'admin' && (
                                        <Link 
                                            href="/create" 
                                            className="bg-primary dark:bg-secondary text-on-primary px-6 py-2 font-label-caps text-label-caps dark:hover:bg-on-surface-variant transition-colors flex items-center gap-2"
                                        >
