                    ...
                    <nav className="hidden md:flex items-center gap-8 h-full">
                        <Link 
                            ...
                            className={`relative py-6 transition-colors font-medium flex items-center group ${
                                activePage === 'home' 
                                    ...
                                    : 'text-slate-700 hover:text-secondary dark:text-zinc-300 dark:hover:text-secondary'
                            }`}
                        >
                            <span className={`pb-1 ${
                                activePage === 'home' 
                        ...
                        {['articles', 'trending', 'about'].map((item) => (
                            <Link 
                                ...
                                className={`relative py-6 transition-colors font-medium flex items-center group ${
                                    activePage === item 
                                        ? 'text-on-secondary dark:text-on-secondary' 
                                        : 'text-secondary hover:text-secondary dark:text-secondary dark:hover:text-secondary'
                                }`}
                            >
