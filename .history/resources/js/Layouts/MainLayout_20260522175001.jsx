...
export default function MainLayout({ children, activePage, categories = [] }) {
    ...
    return (
        <div className="min-h-screen bg-background text-on-background font-body-md">
            {/* Header / Navbar */}
            <header className="bg-surface dark:border-b border-outline-variant dark:bg-[#121212] text-primary dark:text-white border-outline-variant dark:border-zinc-800">
