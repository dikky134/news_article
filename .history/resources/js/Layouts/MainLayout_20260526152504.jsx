                        ...
                        <div className="hidden md:flex items-center gap-6">
                            {auth.user ? (
                                ...
                                <button 
                                    onClick={(e) => {
                                        e.preventDefault();
                                        setIsCategoryOpen(false); // Pastikan layar penutup mati
                                        router.visit('/login');
                                    }} 
                                    className="font-bold text-[11px] hover:text-secondary dark:hover:text-amber-500 tracking-widest uppercase italic cursor-pointer text-left relative z-50"
                                >
                                    Sign In
                                </button>
                            )}
