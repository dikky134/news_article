...
export default function MainLayout({ children, activePage, categories = [] }) {
    ...
    return (
        <div className="min-h-screen bg-background text-on-background font-body-md bg-surface dark:bg-[#121212] text-primary dark:text-white border-outline-variant dark:border-zinc-800">
            ...
            {/* Main Content Area */}
            <main className="w-full max-w-content-max-width mx-auto px-margin-edge py-12 min-h-[60vh] bg-surface dark:bg-[#121212] text-primary dark:text-white border-outline-variant dark:border-zinc-800">
                {isPageLoading ? (
                    <EditorialSkeleton />
                ) : (
                    children
