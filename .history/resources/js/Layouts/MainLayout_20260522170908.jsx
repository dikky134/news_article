...
export default function MainLayout({ children, activePage, categories = [] }) {
    ...
    return (
        <div className="min-h-screen bg-background text-on-background font-body-md">
            ...
            {/* Footer */}
            <footer className="bg-surface dark:bg-[#121212] text-primary dark:text-white border-outline-variant dark:border-zinc-800 w-full px-margin-edge py-16 flex flex-col items-center border-t border-outline-variant bg-surface-container-lowest mt-5">
