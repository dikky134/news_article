                        ...
                        <>
                            ...
                            {auth.user.role === 'admin' && (
                                <Link 
                                    ...
                                    className="bg-primary dark:bg-on-secondary text-white dark:text-primary px-4 py-2 text-[10px] font-bold tracking-widest uppercase hover:bg-black/80 transition-all"
                                >
                                    + Write Story
                                </Link>
                            )}
