...
export default function MainLayout({ children, activePage, categories = [] }) {
    ...
    // Ekstraksi Data Otentikasi Secara Aman dari Inertia Shared Props
    const { auth } = usePage().props;
    const user = auth?.user ?? null;

    // Helper untuk mengekstrak string nama role dari objek atau teks biasa secara aman
    ...
    return (
        <div className="min-h-screen bg-background text-on-background font-body-md bg-surface dark:bg-[#121212] text-primary dark:text-white border-outline-variant dark:border-zinc-800">
                ...
                <div className="flex justify-between items-center w-full px-margin-edge max-w-content-max-width mx-auto">
                    ...
                    <div className="flex items-center gap-6 py-6">
                            ...
                            <>
                                <div className="flex flex-col items-end">
                                    <span className="text-[10px] font-bold text-secondary dark:text-amber-500 uppercase tracking-widest">
                                        {/* AMAN: Mengekstrak teks dari string/objek role secara aman */}
                                ...
                                {/* AMAN: Pengecekan string admin yang aman dari objek */}
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            {/* Tombol Menu Mobile (Hanya di Layar Kecil) */}
                            <button
            ...
            {/* Main Content Area */}
            <main className="w-full overflow-x-hidden max-w-content-max-width mx-auto px-margin-edge py-12 min-h-[60vh] bg-surface dark:bg-[#121212] text-primary dark:text-white border-outline-variant dark:border-zinc-800">
                {isPageLoading ? (
                    <EditorialSkeleton />
                ) : (
                    children
